...
public class Transformations {
	public static void main(String[] args) {
		...
		JavaPairRDD<String, Integer> monExpflattened1 = monExpRDD.flatMapValues(
				v -> {
					List<Integer> result = Arrays.asList(v.split(",")).stream()
	...
	//	System.out.println(pairRDD3.getNumPartitions());
		...
		JavaPairRDD<String, Integer> flatMapToPair = stringRDD.flatMapToPair((PairFlatMapFunction<String, String, Integer>) s -> 
